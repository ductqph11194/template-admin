...
const Login = () => {
   ...
   return (
      <div className="bt-form-login-simple-1">
         ...
         <p className="form-desc">Continue with Google or enter your details</p>
         ...
         <form className="form" autoComplete="off">
            ...
            <CustomButton label={'Login'} color={'#1dc071'} size="large" onClick={handleClickOpen} type={'submit'} />
         </form>
         <div className="form-option">
            Dont&#x27;t have am account? <a href="#">Sign up for free</a>
         </div>
      </div>
   )
}
